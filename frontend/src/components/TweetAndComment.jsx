    ...
    <>
      ...
      >
        <textarea
          ...
          className="p-2 text-sm pr-16 focus:border-white text-white border border-slate-500 bg-[#222222] outline-none w-full rounded"
          {...register("content", { required: true })}
          rows={2}  
        />
        <Button
          type="submit"
          className="bg-(--brand) px-2 py-1 hover:scale-110 transition-all ease-in absolute sm:bottom-8 sm:right-8 bottom-8 right-4 text-xs sm:text-base"
        >
          Send
        </Button>
      </form>
